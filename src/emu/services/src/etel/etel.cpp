...
namespace eka2l1 {
    constexpr std::uint32_t SYSTEM_AGENT_PROPERTY_CATEGORY = 0x102021B1;
    ...
    void etel_server::init(kernel_system *kern) {
        ...
        call_status_prop_->first = SYSTEM_AGENT_PROPERTY_CATEGORY;
        ...
        sim_c_status_prop_->first = SYSTEM_AGENT_PROPERTY_CATEGORY;
        ...
        network_bars_prop_->first = SYSTEM_AGENT_PROPERTY_CATEGORY;
        ...
        battery_bars_prop_->first = SYSTEM_AGENT_PROPERTY_CATEGORY;
        ...
        charger_status_prop_->first = SYSTEM_AGENT_PROPERTY_CATEGORY;
        ...
        if (server<etel_server>()->legacy_level() <= ETEL_LEGACY_LEVEL_TRANSITION) {
            ...
            default:
                ...
                if (subsess_id && (subsess_id.value() > 0)) {
                    if (subsess_id.value() <= subsessions_.size() && subsessions_[subsess_id.value() - 1]) {
