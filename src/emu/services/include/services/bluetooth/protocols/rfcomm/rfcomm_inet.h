...
namespace eka2l1::epoc::bt {
    class rfcomm_inet_protocol : public socket::protocol {
    private:
    ...
    public:
        ...
        std::u16string name() const override { return u"RFCOMM"; }
        std::vector<std::uint32_t> family_ids() const override { return { 0x0101 }; }
        std::vector<std::uint32_t> supported_ids() const override { return { 0x0003 }; }
